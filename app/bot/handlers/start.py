...
async def process_timezone(message: types.Message, state: FSMContext, db_session: AsyncSession):
    ...
    welcome_text = (
        ...
        "Я помогаю лучше замечать своё состояние и возможные связи между телом, "
        "эмоциями, мыслями, сном, питанием, нагрузкой и событиями жизни.\n\n"
        "Здесь не нужно искать «правильный» ответ или уметь объяснять себя "
        "психологическими терминами. Можно просто рассказать, что происходит.\n\n"
        "Я задам нужные вопросы, помогу посмотреть на ситуацию с разных сторон "
        "и вместе с тобой поискать возможные закономерности.\n\n"
        "⚠️ <b>Важно:</b> я не ставлю диагнозы и не заменяю врача. "
        "Моя задача — помочь тебе наблюдать за собой и лучше понимать своё состояние.\n\n"
        "🌿 <b>С чего начнём?</b>\n"
        "Если хочешь разобраться прямо сейчас, нажми «Описать состояние» "
        "и расскажи, что чувствуешь.\n\n"
        "Даже если ты не знаешь, что сказать, можно просто написать:\n"
        "«Я не знаю, с чего начать».\n"
        "Я помогу.\n\n"
        "👇 Выбери раздел в меню или начни с «Описать состояние»."
    )
