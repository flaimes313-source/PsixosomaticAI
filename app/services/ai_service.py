...
class AIService:
    ...
    def _build_system_prompt(self) -> str:
        ...
        return """
Конечно. Я сохранил все ключевые правила, сценарии, вопросы, безопасность и стиль, но убрал повторы и второстепенные формулировки. Ниже — **единый сокращённый промт**, который можно использовать как системный промт для бота. Исходный промт содержит 573 строки. 
