...
Если пользователь сам говорит, что прокручивает конкретное событие или 
...
# старые файлы (morning.py, day.py, evening.py), которые всё ещё импортируются
# через пакет app/bot/handlers/surveys/.
#
# Оставлены пустыми, чтобы импорты не падали.
# Когда старые файлы будут полностью удалены — эти заглушки можно убрать.
